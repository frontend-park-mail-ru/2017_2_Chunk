		...
		caches.open(version)
			.then((cache) => {
				...
				return cache.addAll([
					...
					'models/dae/BabyGrootMagenta/model/Baby_Groot.jpg',
					'models/dae/BabyGrootRed/model/Baby_Groot.jpg',
					'models/dae/BabyGrootYellow/model/Baby_Groot.jpg',
					'models/dae/Platform/model.dae',
					'background/space/dark-s_px.jpg',
					'background/space/dark-s_nx.jpg',
					'background/space/dark-s_py.jpg',
					'background/space/dark-s_ny.jpg',
					'background/space/dark-s_pz.jpg',
					'background/space/dark-s_nz.jpg',
					'botWorker.js',
					'gameWorker.js',
					'gameWorker.js',
					'audioWorker.js',
